...
val record = recordList[position]
        ...
        val ratingHolder = holder.rating
        val successHolder = holder.successTV
        val emotionHolder = holder.emotionTV
        val timeCreatedHolder = holder.timeCreated
        val sourcesHolder = holder.sourcesTV
